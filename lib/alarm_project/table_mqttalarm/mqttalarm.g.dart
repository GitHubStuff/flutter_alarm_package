...
class MQTTAlarm extends SQL.SQLParse<MQTTAlarm> {
  ...
  static const String columnMqttMeta = 'mqttMeta';
  ...
  MQTTMeta _mqttMeta;
  MQTTMeta get mqttMeta => _mqttMeta;
  setMqttMeta(dynamic newValue) => _mqttMeta = MQTTMeta.build(newValue);
  ...
  Map<String, dynamic> toCloud() => {
        ...
        'originatorId': originatorId,
        'status': status,
        'uniqueQualifer': uniqueQualifier,
      };
  ...
  factory MQTTAlarm.fromCloud(Map<String, dynamic> json) {
    var _instance = MQTTAlarm(
      ...
      originatorId: json['originatorId'],
      status: json['status'],
      uniqueQualifier: json['uniqueQualifer'],
    );
    return _instance;
  }
  ...
  Future<SQL.SQLiteLink> createLink({SQL.SQLiteLink sqlLink}) async {
    ...
    await mqttMeta.createLink(sqlLink: childLink);
  ...
  Future<void> updateLink({SQL.SQLiteLink sqlLink}) async {
    ...
    await mqttMeta.updateLink(sqlLink: childLink);
  ...
  Future<void> deleteLink({SQL.SQLiteLink sqlLink}) async {
    ...
    await mqttMeta.deleteLink(sqlLink: childLink);
    return null;
  }
